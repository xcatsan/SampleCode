...
#import "BlogAssistant_AppDelegate.h"
#import "Homepage.h"
@implementation BlogAssistant_AppDelegate


/**
    Returns the support folder for the application, used to store the Core Data
    store file.  This code uses a folder named "BlogAssistant" for
...
- (NSString *)applicationSupportFolder {
    ...
    return [basePath stringByAppendingPathComponent:@"BlogAssistant"];
}
